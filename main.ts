...
import { useApiAdminStudentAppointments } from "./routes/api/admin/student/appointments.ts";
import { useApiAdminCoachAppointments } from "./routes/api/admin/coach/appointments.ts";
import { useAdminAppointments } from "./routes/admin/appointments.ts";
...
import { useStudentAppointmentReview } from "./routes/student/appointment/review.ts";
import { useApiStudentAppointmentReview } from "./routes/api/student/appointment/review.ts";
import { useCoachAppointmentReview } from "./routes/coach/appointment/review.ts";
import { useApiCoachAppointmentReview } from "./routes/api/coach/appointment/review.ts";
import { useApiAppointmentReviews } from "./routes/api/appointment/reviews.ts";
import { useApiStudentCoachChange } from "./routes/api/student/coach/change.ts";
import { useAdminNotifications } from "./routes/admin/notifications.ts";
...
import { useApiAdminMigrationsApprove } from "./routes/api/admin/migrations/approve.ts";
